...
ActiveRecord::Schema[7.2].define(version: 20_250_311_140_050) do
  ...
  create_table 'chat_users', force: :cascade do |t|
    ...
    t.index %w[user_id chat_id], name: 'index_chat_users_on_user_id_and_chat_id', unique: true
  ...
  create_table 'filters', force: :cascade do |t|
    ...
    t.bigint 'target_id'
    t.index %w[target_type target_id group user_id],
            name: 'idx_on_target_type_target_id_group_user_id_394635f237', unique: true
    t.index %w[target_type target_id], name: 'index_filters_on_target'
  ...
  create_table 'object_characters', force: :cascade do |t|
    ...
    t.index %w[object_type object_id character_id], name: 'index_object_characters_with_id', unique: true
    t.index %w[object_type object_id], name: 'index_object_characters_on_object'
  end
  ...
  create_table 'object_tags', force: :cascade do |t|
    ...
    t.string 'object_type'
    t.bigint 'object_id'
    t.index %w[object_type object_id tag_id], name: 'index_object_tags_on_object_type_and_object_id_and_tag_id',
                                              unique: true
  ...
  create_table 'rollups', force: :cascade do |t|
    ...
    t.float 'value'
    t.index %w[name interval time dimensions],
            name: 'index_rollups_on_name_and_interval_and_time_and_dimensions', unique: true
  end
  ...
  create_table 'snapshot_items', force: :cascade do |t|
    ...
    t.index %w[item_type item_id], name: 'index_snapshot_items_on_item'
    t.index %w[snapshot_id item_id item_type],
            name: 'index_snapshot_items_on_snapshot_id_and_item_id_and_item_type', unique: true
  ...
  create_table 'snapshots', force: :cascade do |t|
    ...
    t.json 'metadata'
    t.datetime 'created_at', null: false
    t.index %w[identifier item_id item_type], name: 'index_snapshots_on_identifier_and_item_id_and_item_type',
                                              unique: true
    t.index ['identifier'], name: 'index_snapshots_on_identifier'
    t.index %w[item_type item_id], name: 'index_snapshots_on_item'
    t.index %w[user_type user_id], name: 'index_snapshots_on_user'
  end
  ...
  create_table 'tags', force: :cascade do |t|
    ...
    t.index %w[lower tag_type polarity], name: 'index_tags_on_lower_and_tag_type_and_polarity', unique: true
    t.index %w[name tag_type polarity], name: 'index_tags_on_name_and_tag_type_and_polarity', unique: true
  ...
  create_table 'tickets', force: :cascade do |t|
    ...
    t.string 'item_type'
    t.bigint 'item_id'
    t.index %w[item_type item_id], name: 'index_tickets_on_item'
