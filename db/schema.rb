...
ActiveRecord::Schema[7.0].define(version: 20_220_612_073_239) do
  ...
  create_table 'filters', force: :cascade do |t|
    ...
    t.index %w[user_id tag_id group], name: 'index_filters_on_user_id_and_tag_id_and_group', unique: true
  ...
  create_table 'prompt_tags', force: :cascade do |t|
    t.bigint 'prompt_id'
    t.bigint 'tag_id'
    t.index %w[prompt_id tag_id], name: 'index_prompt_tags_on_prompt_id_and_tag_id', unique: true
