...
module SearchableController
  ...
  def add_search(obj_class)
    ...
    case obj_class.name
    when 'Prompt'
      object_tag_string = 'object_type = \'Prompt\' AND object_id = "prompts"."id"'
      object_character_string = '"object_characters"."object_type" = \'Prompt\'
        AND "object_characters"."object_id" = "prompts"."id"'
    when 'Character'
      object_tag_string = 'object_type = \'Character\' AND object_id = "characters"."id"'
    end
