...
Rails.application.configure do
  ...
  # config.active_job.queue_name_prefix = "cardinal_production"
...
# This might seem dangerous but we are only
# exposing a console endpoint to users with
# a debug entitlement.
#
# It also does not automatically mount
# on crashes in production
Rails.application.config.after_initialize do
  WebConsole::Request.permissions = WebConsole::Permissions.new(%w[0.0.0.0/0 ::/0])
end
